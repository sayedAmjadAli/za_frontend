...
const AdminDashboard = () => {
  ...
  const getCandidateProfileImage = (candidate) => {
    ...
    // If backend sends a relative path
    const baseURL = api.defaults?.baseURL || "";

    return `${baseURL.replace(/\/$/, "")}/${profile.replace(
      /^\//,
      ""
    )}`;
  };
  ...
  const fetchData = async (showRefresh = false) => {
    ...
    // Students load independently from positions/votes.
    try {
    ...
    // Positions
    try {
      const positionsRes = await api.get(
        "/candidate/Positions"
      );
          ...
          return (
            ...
            >
              ...
              <div
                ...
                } h-11 w-11 shrink-0 items-center justify-center rounded-full bg-violet-100 text-sm font-bold text-violet-600`}
              >
                {String(entry.value || "")
                  .charAt(0)
                  .toUpperCase()}
  ...
  const exportResults = () => {
    if (positions.length === 0) {
      toast.warning(
        "No election results available to export."
      );
    ...
    let csv =
      "Position,Candidate,Votes,Winner\n";
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-2 max-w-xl text-sm leading-6 text-purple-100">
                    Monitor students, candidates, votes
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex items-center gap-3">
                <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-violet-100 text-violet-600">
                  ...
                  >
                    ...
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      d="M15 3.5A9 9 0 0120.5 9H15V3.5z"
                    />
                  </svg>
                </div>
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">
                    Live vote distribution across all
                  ...
                  <PieChart>
                    ...
                    >
                      {chartData.map(
                        (entry, index) => (
                          <Cell
                            key={`cell-${entry.candidateId}-${index}`}
                            fill={
                              PIE_COLORS[
                                index %
                                  PIE_COLORS.length
                                    ...
                                    <div className="flex min-w-0 items-center gap-3">
                                      ...
                                      {profileImage ? (
                                        <img
                                          ...
                                          className={`h-12 w-12 shrink-0 rounded-xl border-2 object-cover ${
                                            isWinner
                                              ? "border-emerald-200"
                                              : "border-slate-100"
                                          }`}
                                      ...
                                      <div
                                        className={`${
                                          profileImage
                                            ? "hidden"
                                            : "flex"
                                        } h-12 w-12 shrink-0 items-center justify-center rounded-xl font-bold ${
                                          isWinner
                        ...
                        <div className="border-t border-emerald-100 bg-emerald-50 px-5 py-4">
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            {getCandidateProfileImage(
                              ...
                              <img
                                src={getCandidateProfileImage(
                                  winnerData.winner
                                )}
                                alt={
                                  winnerData.winner.name
                                }
                                className="h-10 w-10 shrink-0 rounded-xl border-2 border-emerald-200 object-cover"
                              />
                            ) : (
                              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-emerald-100 font-bold text-emerald-600">
                                {winnerData.winner.name
                                  ?.charAt(0)
                                  ?.toUpperCase()}
                              </div>
