...
const Election = () => {
  ...
  const fetchResults = async (showRefresh = false) => {
    ...
    try {
      ...
      if (showRefresh) {
        toast.success("Election data refreshed successfully");
      }
    } catch (error) {
      console.error(
  ...
  const totalWinners = positions.reduce(
    (total, position) =>
      total + (position.candidates?.length ? 1 : 0),
    0
  );
  ...
  const exportResults = () => {
    if (!showResults) {
      toast.warning(
        "Unlock the election results before exporting."
      );
      return;
    }
      ...
      <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4">
        <div className="text-center">
          ...
          <p className="mt-1 text-sm text-slate-500">
            Please wait while election data is loaded...
          </p>
        </div>
      </div>
    );
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-6 overflow-hidden rounded-3xl bg-gradient-to-br from-violet-600 via-purple-600 to-indigo-700 p-6 text-white shadow-xl shadow-purple-200/50 sm:p-8">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center">
              ...
              {/* BOTH LOGOS - SAME AS ADMIN DASHBOARD */}
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-2 max-w-xl text-sm leading-6 text-purple-100">
                    Securely reveal the final election results,
                    vote distribution and winners.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex min-h-[430px] items-center justify-center p-6">
              ...
              <div className="w-full max-w-md rounded-3xl border border-violet-200 bg-gradient-to-br from-violet-50 via-white to-indigo-50 p-6 text-center shadow-sm sm:p-8">
                ...
                <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-violet-100 text-violet-600">
                  ...
                  >
                    ...
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      d="M5.25 10.5V8.25a6.75 6.75 0 0113.5 0v2.25M6.75 10.5h10.5A1.5 1.5 0 0118.75 12v7.5A1.5 1.5 0 0117.25 21H6.75a1.5 1.5 0 01-1.5-1.5V12A1.5 1.5 0 016.75 10.5z"
                    />
                  </svg>
                </div>
                ...
                <p className="mt-2 text-sm leading-6 text-slate-500">
                  Enter the secret password. After the correct
                  password is entered, the results will appear
                  after a 10-minute countdown.
                </p>
                ...
                <button
                  ...
                  disabled={
                    unlockingResults || !resultPassword
                  }
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
          ...
          <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">
                Candidate performance and winners for every
                position.
              </p>
            </div>
          ...
          {!showResults ? (
            ...
            <div className="rounded-2xl border border-violet-100 bg-violet-50/60 p-10 text-center">
              ...
              <p className="mt-1 text-sm text-slate-500">
                Enter the password above and wait for the
                10-minute countdown to view detailed results.
              </p>
            </div>
        ...
        <div className="py-6 text-center">
          <p className="text-xs text-slate-400">
            Election Results • Secure • Simple • Reliable
          </p>
        </div>
